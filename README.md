...
Abrir el símbolo del sistema (CMD) y ejecutar los siguientes comandos uno por uno:
...
Si el ZIP se extrajo en una carpeta diferente a `C:\legal-hub`, reemplazar esa ruta con la correcta. Importante: usar doble barra invertida `\\` en todas las rutas.
